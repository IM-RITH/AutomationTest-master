...
public class CreateComment {
    ...
    public static void createCommentSuccessful() throws IOException {
        System.out.println("Unit test: Create comment successful");
        URL url = new URL(Constant.CREATE_COMMENT + "/1");
        ...
        params.put("content", "Very good!");
        params.put("comment_last_id", "1");
