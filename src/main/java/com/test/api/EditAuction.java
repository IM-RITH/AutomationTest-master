...
public class EditAuction {
    ...
    public static void editAuctionsSuccessful() throws IOException {
        System.out.println("Unit test: Edit auctions successful");
        URL url = new URL(Constant.EDIT_AUCTION + "/200");
        ...
        params.put("start_date", "06/29/2022");
        params.put("end_date", "08/28/2022");
        params.put("title_ni", "Phien dau gia test (Edited)");
    ...
    public static void missingCategoryId() throws IOException {
        System.out.println("Unit test: Edit auctions when missing category id");
        URL url = new URL(Constant.EDIT_AUCTION +"/200");
        HttpURLConnection connection = (HttpURLConnection) url.openConnection();
