...
public class GetListComment {
    ...
    public static void getListCommentSuccessful() throws IOException {
        System.out.println("Unit test: Get list comment successful");
        URL url = new URL(Constant.GET_LIST_COMMENT + "/1?index=0&count=3");
