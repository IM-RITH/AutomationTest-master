...
public class ReadNotification {
    ...
    public static void readNotificationSuccessful() throws IOException {
        System.out.println("Unit test: Read notification successful");
        URL url = new URL(Constant.READ_NOTIFICATION + "/1");
