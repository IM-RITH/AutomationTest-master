...
public class LikeAuction {
    ...
    public static void likeAuctionSuccessful() throws IOException {
        System.out.println("Unit test: Like auction successful");
        URL url = new URL(Constant.LIKE_AUCTION + "/200");
