...
public class CreateAuction {
    ...
    public static void createAuctionsSuccessful() throws IOException {
        System.out.println("Unit test: Create auctions successful");
        URL url = new URL(Constant.CREATE_AUCTION);
        ...
        params.put("start_date", "06/28/2022");
        params.put("end_date", "07/28/2022");
        params.put("title_ni", "Phien dau gia test 2");
    ...
    public static void startDateIncorrect() throws IOException {
        System.out.println("Unit test: Create auction when start date before now");
        URL url = new URL(Constant.CREATE_AUCTION);
        HttpURLConnection connection = (HttpURLConnection) url.openConnection();
        ...
        Map<String, String> params = new HashMap<>();
        params.put("category_id", "1");
        params.put("start_date", "05/28/2022");
        params.put("end_date", "07/28/2022");
        params.put("title_ni", "Phien dau gia test");
