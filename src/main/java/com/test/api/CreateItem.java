...
public class CreateItem {
    ...
    public static void createItemsSuccessful() throws IOException {
        System.out.println("Unit test: Create item successful");
        URL url = new URL(Constant.CREATE_ITEM + "/200");
        ...
        params.put("starting_price", "100000");
        params.put("brand_id", "1");
        params.put("description", "This is item 1");
