...
public class GetNotifications {
    ...
    public static void getNotificationsIsReadSuccessful() throws IOException {
        System.out.println("Unit test: Get notifications is read successful");
        URL url = new URL(Constant.GET_NOTIFICATIONS + "?index=0&count=3&is_not_read=0");
    ...
    public static void getNotificationsIsNotReadSuccessful() throws IOException {
        System.out.println("Unit test: Get notifications is not read successful");
        URL url = new URL(Constant.GET_NOTIFICATIONS + "?index=0&count=3&is_not_read=1");
        HttpURLConnection connection = (HttpURLConnection) url.openConnection();
