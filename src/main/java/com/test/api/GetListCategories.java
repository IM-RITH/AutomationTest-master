...
public class GetListCategories {
    ...
    public static void getListCategoriesSuccessful() throws IOException {
        System.out.println("Unit test: Get list categories successful");
        URL url = new URL(Constant.GET_LIST_CATEGORIES);
