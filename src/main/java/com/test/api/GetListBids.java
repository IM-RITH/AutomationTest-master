...
public class GetListBids {
    ...
    public static void getListBidsSuccessful() throws IOException {
        System.out.println("Unit test: Get list bids successful");
        URL url = new URL(Constant.GET_LIST_BIDS + "/200?index=0&count=3");
