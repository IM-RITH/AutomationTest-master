...
public class GetListBrands {
    ...
    public static void getListBrandsSuccessful() throws IOException {
        System.out.println("Unit test: Get list brands successful");
        URL url = new URL(Constant.GET_LIST_BRANDS);
